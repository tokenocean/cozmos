                  ...
                  <div class="my-auto ml-auto">
                    {#if val(asset, Math.abs(totals[username][asset]))}
                      <div class="mr-1 ml-auto">
                        {parseFloat(val(asset, Math.abs(totals[username][asset]))).toFixed(8)}
                      </div>
                    {/if}
                  </div>
    ...
    {#if showDetails}
      <div class="text-sm break-all text-wrap">
              ...
              <div class="mb-2 p-4 border">
                ...
                {#if input.asset}
                  <div class="mb-2">
                    ...
                    <a
                      href={`${explorer}/asset/${input.asset}`}>{input.asset}</a>
                  </div>
                {/if}
                ...
                <div class="mb-2">
                  <a
                    href={`${explorer}/address/${input.scriptpubkey_address}`}>{input.scriptpubkey_address}</a>
                </div>
                <div class="mb-2">
                ...
                <div class="mb-2 p-4 border">
                  ...
                  <div>
                    ...
                    {:else if out.value}
                      <div class="text-gray-400 text-xs">Address</div>
                      <a
                        href={`${explorer}/address/${out.address}`}>{out.address}</a>
                    {:else}
        ...
        <div class="grid grid-cols-2 gap-4">
          ...
          <button
            class="primary-btn mb-2"
            on:click={() => copy(tx.toHex())}>Copy Tx Hex</button>
        </div>
      </div>
    {/if}
  </div>
