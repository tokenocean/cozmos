<div class="background-gradient p-10 md:p-32 text-white">
  <div class="w-full md:w-2/3 lg:w-1/2">
    ...
    <p>
      At Cozmos Experiences, accessible from https://cozmos.io, one of our main
      priorities is the privacy of our visitors. This Privacy Policy document
      contains types of information that is collected and recorded by Cozmos
      Experiences and how we use it. If you have additional questions or require
      more information about our Privacy Policy, do not hesitate to contact us.
      This Privacy Policy applies only to our online activities and is valid for
      visitors to our website with regards to the information that they share
      and/or collect in Cozmos Experiences. This policy is not applicable to any
      information collected oﬄine or via channels other than this website.
    </p>
  </div>
</div>
<div class="bg-black p-10 md:p-32 pb-10 text-white space-y-10">
  ...
  <div class="border-b-2 border-white pb-10">
    ...
    <p>
      ...
      address, public Ethereum address, social media proﬁles, phone number, the
      ...
      company name, address, public Ethereum address, social media ﬁles, email
  ...
  <div class="border-b-2 border-white pb-10">
    ...
    <p>
      ...
      log ﬁles include internet protocol (IP) addresses, browser type, Internet
      Service Provider (ISP), date and time stamp, referring/exit pages, and
      possibly the number of clicks. These are not linked to any information
      that is personally identiﬁable. The purpose of the information is for
  ...
  <div class="border-b-2 border-white pb-10">
    ...
    <p>
      ...
      Cosmos Experiences, which are sent directly to users' browser. They
      automatically receive your IP address when this occurs. These technologies
      are used to measure the eﬀectiveness of their advertising campaigns and/or
      to personalize the advertising content that you see on websites that you
      visit. Note that Cozmos Experiences has no access to or control over these
  ...
  <div class="border-b-2 border-white pb-10">
    ...
    <p>
      ...
      with speciﬁc web browsers, it can be found at the browsers' respective
      websites.
    </p>
  </div>
  <div class="border-b-2 border-white pb-10">
    ...
    <p>
      ...
      disclose the categories and speciﬁc pieces of personal data that a
  ...
  <div class="border-b-2 border-white pb-10">
    ...
    <p>
      ...
      may charge you a small fee for this service. The right to rectiﬁcation –
  ...
  <div class="border-b-2 border-white pb-10">
    ...
    <p>
      ...
      in, and/or monitor and guide their online activity. Cozmos Experiences
      does not knowingly collect any Personal Identiﬁable Information from
      ...
      us immediately and we will do our best eﬀorts to promptly remove such
