...
<div class="bg-black p-10 md:p-20 pb-10 text-white space-y-10">
  <div class="border-b-2 border-white pb-10">
    ...
    <p>
      Our goal is to bring together a community of creators and lovers of life
      to engage in the ﬁrst marketplace that oﬀers once-in-a-lifetime
      Events/Experiences.
    </p>
  </div>
  <div class="border-b-2 border-white pb-10">
    ...
    <p>
      ...
      with your favorite Youtuber, an exclusive access to the biggest festival in
      the world or a sparring session with your favorite boxer, sky’s the limit.
    </p>
    <ul class="ml-5 my-5 list-disc font-bold">
      <li>Low minting fees.</li>
      <li>No gas wars.</li>
  ...
  <div class="border-b-2 border-white pb-10">
    ...
    <div class="block md:flex justify-center md:space-x-20">
      ...
      />
      <div>
        <p class="font-bold mb-5">Sergio Leon Rodriguez. CEO</p>
        <p>
          I have been in the crypto world since 2017 and have been through the
          ups and downs, I was a Forex trader before but when I discovered the
          opportunities and possibilities of blockchain technology I stopped and
          just focused on that. When I came across NFTs at the beginning of 2021
          it got me fascinated and I started buying/selling NFTs and realizing
    ...
    <div class="block md:flex justify-center md:space-x-20">
      ...
      />
      <div>
        <p class="font-bold mb-5">Juan Teruel. CDO</p>
        <p>
          Creative and eccentric from birth – Juan found his calling in the
          design and art world. Racking up over 10 years of art & design
          experience alongside over 30 countries traveled with watercolors
          always to hand.
        </p>
        <div class="flex">
          <a href="">
  ...
  <div class="border-b-2 border-white pb-10">
    ...
    <p>
      ...
      with us and deposit BTC,L-BTC or BTC LIGHTNING and start buying or selling
      NFT-experiences. By utilizing the Liquid sidechain settlement network we
      are enabling the bitcoin blockchain for your NFT asset creation and
      distribution. All Liquid Bitcoin (L-BTC) based NFT assets are backed
    ...
    <p>The sceret door to your wildest dreams.</p>
  </div>
</div>
