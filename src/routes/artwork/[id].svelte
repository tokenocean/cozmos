...
<script>
  ...
  $: actionClassName =
    artwork && artwork.list_price ? "buy-now-button-bg" : "place-bid-button-bg";

  $: coverImage =
    artwork && artwork.cover_filename
      ? `/api/ipfs/${artwork.cover_filename}`
  ...
  <div class="flex">
    <div class="w-1/3 mr-16">
      ...
      {#if $user && $user.id === artwork.owner_id}
        ...
        <div class="mt-4">
          <a href={disabled ? '' : `/artwork/${id}/auction`}>
    ...
    <div class="w-3/4 ml-16">
      ...
      <div class="mt-16">
        ...
        <div class="mt-12">
          ...
          <div class="mt-4">
            {#if artwork && artwork.tags && !artwork.tags.length}No tags{/if}
