...
<button {type} {disabled} on:click class:ghostWhite class:primary class:hover class="h-12 px-8 rounded-lg button flex justify-center items-center {$$props.class || ''}"><slot/></button>
