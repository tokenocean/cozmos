...
let fields =
  "id, username, location, bio, email, full_name, website, twitter, instagram, discord, tiktok, youtube, facebook, twitch, avatar_url, cover_photo_url, address, multisig, pubkey, is_artist, prompt_sign";
